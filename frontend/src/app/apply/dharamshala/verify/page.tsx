    ...
    <div className="min-h-screen" style={{ background: "var(--bg-page)" }}>
      ...
      >
        <div className="mx-auto max-w-6xl flex items-center justify-between">
          <Link href="/apply/dharamshala/contact" className="flex items-center gap-3">
        ...
        <div className="mx-auto max-w-2xl">
                ...
                <div key={index} className="relative">
                  <input
                    ...
                    className={`w-16 h-16 text-2xl font-bold text-center border-2 rounded-lg transition-all ${
                      errors.length > 0 ? 'border-red-500' : 'border-amber-500'
                    } ${
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                {t('Call Dharamshala Office: +91 9769610214', 'धरमशाला कार्यालय: +91 9769610214')}</Link>
